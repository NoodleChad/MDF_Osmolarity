...
from toronto_set_up_charge import optmdfpathway_base_milp_with_osmolarity, optmdfpathway_base_variables, biomass_reaction_id
...
while current_k >= 0.001:
    ...
    if growth_optimization_result["status"] == "Optimal":
        ...
        print("Infeasible!")
        break
with open("./Results/Figure_S1a.csv", "w") as f:
